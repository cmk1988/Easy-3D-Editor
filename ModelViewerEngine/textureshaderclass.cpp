											 ...
											 D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	...
	//dataPtr2->diffuseColor = *new D3DXVECTOR4(1.0f, 1.0f, 1.0f, 0.0f);
	//dataPtr2->lightDirection = *new D3DXVECTOR3(0.0f, 0.0f, 1.0f);

	dataPtr2->diffuseColor.x = 1.0f;
	dataPtr2->diffuseColor.y = 1.0f;
	dataPtr2->diffuseColor.z = 1.0f;
	dataPtr2->diffuseColor.w = 1.0f;

	dataPtr2->lightDirection.x = 1.0f;
	dataPtr2->lightDirection.y = 0.0f;
	dataPtr2->lightDirection.z = 0.0f;

	dataPtr2->ambi.x = 0.15f;
	dataPtr2->ambi.y = 0.15f;
	dataPtr2->ambi.z = 0.15f;
	dataPtr2->ambi.w = 1.0f;

	//if (!isSet)
	//	dataPtr2->diffuseColor = *new D3DXVECTOR4(0.6f, 0.6f, 0.6f, 0.0f);
	//if (!isSet)
	//	dataPtr2->lightDirection = *new D3DXVECTOR3(0.0f, -0.707f, 0.707f);
	//if (!isSet)
	//	dataPtr2->ambi = *new D3DXVECTOR4(0.6f, 0.6f, 0.6f, 0.0f);
	//isSet = true;
	dataPtr2->padding = 0.3f;
